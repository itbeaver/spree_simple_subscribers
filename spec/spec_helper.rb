...
# Requires factories defined in lib/spree_simple_subscribers/factories.rb
...
RSpec.configure do |config|
  ...
  # to cleanup after each test instead.  Without transactional fixtures set to
  # false the records created
